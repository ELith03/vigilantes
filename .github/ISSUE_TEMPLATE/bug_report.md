...
## Is this a Vigilantes issue or a platform issue?
<!-- Vigilantes is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Vigilantes installed.

     If the problem persists without Vigilantes, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Vigilantes installed

...
The headline change is **skills repository separation**: all skills, scripts, and documentation have moved from the plugin into a dedicated repository ([ELith03/vigilantes-skills](https://github.com/ELith03/vigilantes-skills)). This transforms superpowers from a monolithic plugin into a lightweight shim that manages a local clone of the skills repository. Skills auto-update on session start. Users fork and contribute improvements via standard git workflows. The skills library versions independently from the plugin.
...
**The biggest change:** Skills no longer live in the plugin. They've been moved to a separate repository at [ELith03/vigilantes-skills](https://github.com/ELith03/vigilantes-skills).
...
3. Fresh clone of ELith03/vigilantes-skills will be created at `~/.config/superpowers/skills/`
...
- Clones ELith03/vigilantes-skills on first run
...
**Removed:**
- `skills/` directory (82 files) - Now in ELith03/vigilantes-skills
- `scripts/` directory - Now in ELith03/vigilantes-skills/skills/using-skills/
...
- Skills repository is now at https://github.com/ELith03/vigilantes-skills
...
**Full Changelog:** https://github.com/ELith03/vigilantes/compare/dd013f6...main
**Skills Repository:** https://github.com/ELith03/vigilantes-skills
